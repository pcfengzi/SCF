using Examination.Functions;
using Examination.Models.DatabaseModel;
...
namespace Examination
{
        ...
        IXscfRazorRuntimeCompilation  //需要使用 RazorRuntimeCompilation，在开发环境下实时更新 Razor Page
    {
        ...
        public override string Name => "麻雀课堂考试系统";
        public override string Uid => "925A392E-247D-FBD6-7DFF-569B44E38095";//必须确保全局唯一，生成后必须固定
        public override string Version => "0.2.2";//必须填写版本号

        public override string MenuName => "麻雀课堂考试系统";
        ...
        {
            //更新数据库
            await base.MigrateDatabaseAsync<MyExaminationEntities>(serviceProvider);
        ...
        {
            MyExaminationEntities mySenparcEntities = serviceProvider.GetService<MyExaminationEntities>();
        ...
        public string HomeUrl => "/Admin/Examination/HomePage";

        public List<AreaPageMenuItem> AareaPageMenuItems => new List<AreaPageMenuItem>() {
             new AreaPageMenuItem(GetAreaHomeUrl(),"首页","fa fa-laptop"),
             new AreaPageMenuItem(GetAreaUrl("/Admin/Examination/About"),"关于","fa fa-bookmark-o"),
        };
        ...
        public IMvcBuilder AuthorizeConfig(IMvcBuilder builder, IWebHostEnvironment env)
        {
            ...
            SenparcTrace.SendCustomLog("系统启动", "完成 Area:Examination 注册");
        ...
        /// 数据库前缀
        /// </summary>
        public const string DATABASE_PREFIX = "Examination_";
        ...
        /// </summary>
        public Type XscfDatabaseDbContextType => typeof(MyExaminationEntities);
        ...
        public string LibraryPath => Path.GetFullPath(Path.Combine(SiteConfig.WebRootPath, "..", "..", "Examination"));
        #endregion
    }
}
